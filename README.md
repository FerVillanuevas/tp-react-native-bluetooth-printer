...
Install via NPM [Check In NPM](https://www.npmjs.com/package/react-native-bluetooth-printer)

```bash
npm install react-native-bluetooth-printer --save
```

Or install via github

```bash
npm install https://github.com/tulparyazilim/react-native-bluetooth-printer.git --save
```
...
```bash
react-native link react-native-bluetooth-printer
```
